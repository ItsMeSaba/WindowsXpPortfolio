...
import profairgames from "../assets/images/workExperiences/profairgames.png";
import profairgames1 from "../assets/images/workExperiences/profairgames1.png";
import profairgames2 from "../assets/images/workExperiences/profairgames2.png";
...
export const workExperiences: { [key in string]: WorkExperience } = {
  Unisoft: {
    company: "Unisoft",
    description:
      "Unisoft is private university manamgent website, useful for both, lecturers and students. I took part in advancing and correctiong frontend, as well as implementing backend.",
