...
import "../styles/pages/WorkExperienceWindow.sass"
...
export default function WorkExperienceWindow(args: Args) {    
    ...
    return (
        <Window settings={settings} setSettings={setSettings} onBack={() => setCurrentExperience("")}>
            { !currentExperience &&
                <WorkExperiences setCurrentExperience={setCurrentExperience} />
            }

            { currentExperience &&
                <WorkExperience experience={currentExperience} />
            }
        </Window>
    )
}